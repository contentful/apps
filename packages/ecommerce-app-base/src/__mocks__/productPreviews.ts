...
const productPreviews: Product[] = [
  {
    id: '28a7442d',
    image: 'https://example.com/commercetools-example/products/picture-1.jpg',
  ...
  {
    id: '4e5446e8',
    image: 'https://example.com/commercetools-example/products/picture-2.jpg',
  ...
  {
    id: 'db3c234l',
    image: 'https://example.com/commercetools-example/products/picture-3.jpg',
