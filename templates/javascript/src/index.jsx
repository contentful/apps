    ...
    const ComponentLocationSettings = [
      {
        ...
        component: <ConfigScreen cma={cma} sdk={sdk} />,
      },
      {
        location: locations.LOCATION_ENTRY_FIELD,
        component: <Field cma={cma} sdk={sdk} />,
      },
      {
        location: locations.LOCATION_ENTRY_EDITOR,
        component: <EntryEditor cma={cma} sdk={sdk} />,
      },
      {
        location: locations.LOCATION_DIALOG,
        component: <Dialog cma={cma} sdk={sdk} />,
      },
      {
        location: locations.LOCATION_ENTRY_SIDEBAR,
        component: <Sidebar cma={cma} sdk={sdk} />,
      },
      {
        location: locations.LOCATION_PAGE,
        component: <Page cma={cma} sdk={sdk} />,
      },
    ];
