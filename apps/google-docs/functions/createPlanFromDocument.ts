...
/**
 * App function handler that generates a plan (proposed entries) from a Google Doc
 * without actually creating the entries. This allows users to review what will be created.
 */
