      ...
      <>
        ...
        <div className={styles.body}>
          <Typography>
            ...
            <Paragraph>
              The AI Image Tagging app uses AWS Rekognition’s AI and deep learning capabilities to automatically assign tags to images. The tags are visible and accessible via the Contentful web app sidebar and tags are searchable in the search bar.
            </Paragraph>
            <Divider />
