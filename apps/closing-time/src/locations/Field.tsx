...
function formatTimeSlot(
  ...
  return `${formatDisplayTime(slot.open, clockFormat)} - ${formatDisplayTime(slot.close, clockFormat)}`;
}
...
function Field() {
  ...
  const configuredDefaultHours =
    installationParameters.useCustomDefaults &&
    installationParameters.defaultHours
