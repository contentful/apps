...
import { Heading, Form, Paragraph, Button, ButtonGroup } from '@contentful/f36-components';
...
const AuthCredentialsPage = () => {
    ...
    const handleNextStepClick = () => {
        stepperContext.onStepperStatusesChange({ ...stepperContext.stepperStatuses, authCreds: true })
...
export default AuthCredentialsPage;
