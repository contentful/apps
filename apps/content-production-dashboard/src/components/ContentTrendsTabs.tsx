...
export const ContentTrendsTabs: React.FC<ContentTrendsTabsProps> = ({
  ...
  const newEntries = useMemo(() => {
    return processNewEntries(entries, { timeRange }, filteredContentTypesForChart);
  }, [entries, timeRange, filteredContentTypesForChart]);

  const contentTypeData = useMemo(() => {
    return processContentTypeTrends(entries, { timeRange }, filteredContentTypesForChart);
  }, [entries, timeRange, filteredContentTypesForChart]);

  const creatorData = useMemo(() => {
    return processCreatorTrends(
      entries,
      { timeRange },
      creatorsNames,
