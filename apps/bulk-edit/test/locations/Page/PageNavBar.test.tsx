...
const mockContentTypes = [
  { sys: { id: 'condoC' }, name: 'Condo C' },
  { sys: { id: 'condoA' }, name: 'Condo A' },
  { sys: { id: 'condoB' }, name: 'Condo B' },
];

beforeEach(() => {
  mockSdk.cma = {
    contentType: {
      getMany: vi.fn().mockResolvedValue({ items: mockContentTypes }),
    },
  };
});
