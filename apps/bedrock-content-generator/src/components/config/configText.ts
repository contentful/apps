...
const Sections = {
  ...
  costHeading: 'Cost',
  costSubheading: 'Generating content uses AWS resources, depending on the amount of tokens you generate.',
  costDescription: 'View the current pricing model at aws.amazon.com/bedrock/pricing',
...
export { ModelText, BrandProfileFields, Sections, ConfigErrors, ContentTypeText, AccessKeyText };
