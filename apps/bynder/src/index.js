...
setup({
  ...
  parameterDefinitions: [
    ...
    },
    {
      ...
      default: 'SingleSelectFile',
      description: '"SingleSelectFile" allows you to select a specific derivative. If you have already created entries with assets in Single Select mode and switch to Multi Select, please ensure that you are not relying on the selectedFile attribute.',
      required: true,
    },
  ],
  makeThumbnail,
