...
- Installation-time content type assignment for JSON object fields
- Configurable 12-hour or 24-hour editor display
- Optional install-time default hours setup
...
- `12-hour clock`: displays times like `9:00 AM`
- `24-hour clock`: displays times like `09:00`
- `Default hours`: optionally replaces the built-in initial weekly schedule when
  an entry field is empty for the first time
