...
import { getFieldStatus, getFieldType } from '../utils';
          ...
          {fieldDetails.map((field) => {
            ...
            return (
              <Table.Row key={field.id}>
                ...
                <Table.Cell>
                  {field.required ? (
                    <CheckCircleIcon variant="positive" label="Field is required" />
                  ) : (
                    <MissingContent label="Field is optional" className={styles.missingContent} />
                  )}
                </Table.Cell>
                <Table.Cell>
                  {field.localized ? (
                ...
                <Table.Cell>
                  {field.validations?.length ? (
                    ...
                    <MissingContent label="No validations set" className={styles.missingContent} />
                  )}
                </Table.Cell>
              </Table.Row>
            );
